...
export const mockSignatures: Signature[] = [
  ...
  },
  {
    ...
    quote_id: 'quote_001',
    franchisee_id: 'user_franchisee_juan',
    signed_pdf_url: 'https://storage.example.com/signatures/sig_002_signed.pdf',
    signature_hash: 'b4g6e0c3f2d5a8e1b9d2c5f8e1a4b7d0e3f6a9b2c5e8',
    signature_method: 'digital',
    signed_at: new Date('2026-08-20T14:15:00Z'),
    ip_address: '192.168.1.101',
    user_agent: 'Mozilla/5.0 (Windows NT 10.0; Win64; x64)',
    terms_version: '1.0',
    consent_text: 'Acepto los términos y condiciones del presupuesto presentado por Rotulación Pro S.A. por un importe de 8.750 EUR.',
  },
  {
    id: 'sig_003',
    quote_id: 'quote_002',
    franchisee_id: 'user_franchisee_juan',
    signed_pdf_url: 'https://storage.example.com/signatures/sig_003_signed.pdf',
    signature_hash: 'c5h7f1d4g3e6b9f2c8e1d4g7f0a3b6c9f2e5a8b1c4d7e0',
    signature_method: 'digital',
    signed_at: new Date('2026-08-22T10:45:00Z'),
    ip_address: '192.168.1.102',
    user_agent: 'Mozilla/5.0 (iPhone; CPU iPhone OS 14_6 like Mac OS X)',
    terms_version: '1.0',
    consent_text: 'Acepto los términos y condiciones del presupuesto presentado por Equipamientos Comerciales S.L. por un importe de 28.900 EUR.',
  },
];
...
export let mockProjectDocuments: ProjectDocument[] = [
  ...
  // Documents for proj_001 - Madrid Carmen 50
  {
    id: 'doc_006',
    project_id: 'proj_001',
    category: 'equipamientos',
    subcategory: null,
    name: 'Especificación Mobiliario Tienda',
    description: 'Detalles técnicos de estanterías, mostradores refrigerados y mostradores de atención',
    file_url: 'https://storage.example.com/docs/proj_001_mobiliario.pdf',
    file_name: 'mobiliario_especificacion.pdf',
  ...
  },
  {
    ...
    category: 'obras_general',
    subcategory: 'planta',
    name: 'Plano Planta - Madrid Carmen 50',
    description: 'Distribución de 250m² con zona comercial, almacén, zona técnica y oficina',
    file_url: 'https://storage.example.com/docs/proj_001_planta.pdf',
    file_name: 'planta_madrid_carmen50.pdf',
    file_size_bytes: 4194304,
    file_mime_type: 'application/pdf',
    uploaded_by: 'admin_user_id',
  ...
  },
  {
    ...
    file_url: 'https://storage.example.com/docs/proj_001_rotulacion.pdf',
    file_name: 'rotulacion_proyecto.pdf',
    file_size_bytes: 2621440,
    file_mime_type: 'application/pdf',
    uploaded_by: 'admin_user_id',
  ...
  },
  {
    ...
    category: 'obras_electricidad',
    subcategory: 'cuadros',
    name: 'Esquema Eléctrico Completo',
    description: 'Diagrama unifilar con cargas previstas: 40 kW en iluminación y fuerza',
    file_url: 'https://storage.example.com/docs/proj_001_electrico.pdf',
    file_name: 'esquema_electrico.pdf',
    file_size_bytes: 1966080,
    file_mime_type: 'application/pdf',
    uploaded_by: 'admin_user_id',
  ...
  // Documents for proj_002 - Barcelona Paseo de Gracia
  {
    id: 'doc_010',
    project_id: 'proj_002',
    category: 'equipamientos',
    subcategory: null,
    name: 'Especificación Equipos Frigoríficos',
    description: 'Detalles técnicos de vitrinas refrigeradas, congeladores y cámaras',
    file_url: 'https://storage.example.com/docs/proj_002_frigorificos.pdf',
    file_name: 'equipos_frigorificos.pdf',
    file_size_bytes: 2883584,
    file_mime_type: 'application/pdf',
    uploaded_by: 'admin_user_id',
  ...
  },
  {
    ...
    category: 'obras_general',
    subcategory: 'fachada',
    name: 'Plano de Fachada - Reformado',
    description: 'Concepto de fachada moderna con cristaleras y acceso accesible',
    file_url: 'https://storage.example.com/docs/proj_002_fachada.pdf',
    file_name: 'fachada_reforma.pdf',
    file_size_bytes: 3670016,
    file_mime_type: 'application/pdf',
    uploaded_by: 'admin_user_id',
    uploaded_at: '2026-08-02T09:30:00Z',
    is_active: true,
    version: 1,
  },
  {
    ...
    file_url: 'https://storage.example.com/docs/proj_002_informatica.pdf',
    file_name: 'infraestructura_it.pdf',
